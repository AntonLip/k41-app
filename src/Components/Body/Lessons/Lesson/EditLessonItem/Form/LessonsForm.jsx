...
const EditLessonItem = (props) => {
    ...
    return (
        <div>
            ...
            <ImageUpload class="editForm" title={"Методическая разработка"} url={"http://192.168.5.250/api/Lessons/" + props.lesonId + "/methodic"} />
            <ImageUpload class="editForm" title={"Дополнительные материалы"} url={"http://192.168.5.250/api/Lessons/" + props.lesonId + "/additional"} />
            <ImageUpload class="editForm" title={"Презентация"} url={"http://192.168.5.250/api/Lessons/" + props.lesonId + "/presentation"} />
        </div>
    )
}
